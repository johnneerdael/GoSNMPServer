GoSNMPServer
======
[![Build Status](https://travis-ci.org/johnneerdael/GoSNMPServer.svg?branch=master)](https://travis-ci.org/johnneerdael/GoSNMPServer)
[![GoDoc](https://godoc.org/github.com/johnneerdael/GoSNMPServer?status.png)](https://godoc.org/github.com/johnneerdael/GoSNMPServer)
[![codecov](https://codecov.io/gh/johnneerdael/GoSNMPServer/branch/master/graph/badge.svg)](https://codecov.io/gh/johnneerdael/GoSNMPServer)
...
```shell
go install github.com/johnneerdael/GoSNMPServer/cmd/gosnmpserver
...
import "github.com/johnneerdael/GoSNMPServer"
import "github.com/johnneerdael/GoSNMPServer/mibImps"
```
...
Serve your own oids
-----
This library provides some common oid for use. See [mibImps](https://github.com/johnneerdael/GoSNMPServer/tree/master/mibImps) for code, See [![GoDoc](https://godoc.org/github.com/johnneerdael/GoSNMPServe/mibImpsr?status.png)](https://godoc.org/github.com/johnneerdael/GoSNMPServer/mibImps) here.
